...
public class Eleicao {
    private static int numDeVotosValidos;
    private static int maiorVotacao;
    private static List<Candidato> vencedor = new ArrayList<>();;
    private static double porcentagemVencedor;
    private static Candidato maisVelho;
    ...
    static public void cadastrarCandidatos(int num) {
        ...
        for (int i = 0; i < num; i++) {
            ...
            while (Candidato.getCadastroDeCandidatos().containsKey(numero)) { 
                System.out.printf("Digite um número de candidato que não esteja sendo usado: ");
                numero = leitor.nextInt();
                leitor.nextLine();
            }

            new Candidato(nome, data, numero);
        }
    }
    ...
    public static Candidato getMaisVelho() {
        return maisVelho;
    }

    public static double getPorcentagemVencedor() {
        return porcentagemVencedor;
    }

    public static List<Candidato> getVencedor() {
        return vencedor;
    }

    public static int getMaiorVotacao() {
        return maiorVotacao;
    }

    public static int getNumDeVotosValidos() {
        return numDeVotosValidos;
    }
}
